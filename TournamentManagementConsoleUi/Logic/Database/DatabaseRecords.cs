...
public record MatchRecord(Guid Id, DateOnly Date, Guid? FirstPreviousMach, Guid? SecondPreviousMach, Guid? FirstTeam, Guid? SecondTeam, Guid? Winner) : DatabaseRecord(Id);
